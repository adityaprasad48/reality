...
// position sticky remove and add above add banner in header tag
// remove in upscroll
export const MovingNav = () => {
  ...
  return (
    <div
      className={`border p-2 h-[60px] ${direction === "Up" && "sticky_new"}`}
    >
      <h1>postion sticky {direction}</h1>
    </div>
  );
};
